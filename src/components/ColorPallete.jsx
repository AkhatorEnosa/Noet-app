...
const ColorPallete = ({show, addBackground, colorOption}) => {
  return (
    <div className={`absolute flex items-center justify-center bottom-24 md:top-0 ${show ? "scale-100" : "scale-0 translate-y-10"} transition-all duration-150 gap-3 z-50`}>
