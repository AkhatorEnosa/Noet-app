...
const ColorPallete = ({show, addBackground}) => {
  return (
    <div className={show ? "absolute flex items-center justify-center gap-2 z-50" : "hidden"}>
        <div className="relative w-5 h-5 flex justify-center items-center rounded-full bg-white border-[1px] border-black cursor-pointer" onClick={addBackground}></div>
